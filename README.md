# 108_8.11结构体二级指针
## A函数调用B函数改变B函数里面的局部变量（main函数调用initXms()这个函数，改变totao这个局部变量）
![IMG_20230731_103448_edit_573024399186095](https://github.com/xielantu/108_8.11Structure-secondary-pointer/assets/96539157/2662e71d-1bb2-4b6d-965a-7173f5a25940)
